            ...
            html.Div(
                ...
                children = [
                    html.Div(
                        ...
                        children = [
                            html.P(id = "winter-wind-rose-text"),
                            dcc.Graph(
                    ...
                    html.Div(
                        className = "container-col",
                        children = [
                            html.P(id = "spring-wind-rose-text"),
                            dcc.Graph(
                                className = "seasonal-graph",
                                id = "spring-wind-rose",
                                config = config
            ...
            html.Div(
                ...
                children = [
                    html.Div(
                        className = "container-col",
                        children = [
                            html.P(id = "summer-wind-rose-text"),
                            dcc.Graph(
                                className = "seasonal-graph",
                                id = "summer-wind-rose",
                                config = config
            ...
            html.Div(
                ...
                children = [
                    html.Div(
                        className = "container-col",
                        children = [
                            html.P(id = "morning-windrose-text"),
                            dcc.Graph(
