...
class ElementIds(str, Enum):
    ...
    # Shared constants for stores with identical values
    SHARED_DF_STORE = "df-store"
    SHARED_META_STORE = "meta-store"
    SHARED_SI_IP_UNIT_STORE = "si-ip-unit-store"
    SHARED_GLOBAL_LOCAL_RADIO_INPUT = "global-local-radio-input"
    SHARED_SI_IP_RADIO_INPUT = "si-ip-radio-input"
    SHARED_URL_STORE = "url-store"
    SHARED_LINES_STORE = "lines-store"
